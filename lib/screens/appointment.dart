...
class BookAppointment extends StatefulWidget {
  ...
  BookAppointment({Key key, this.userid}) : super(key: key);

  @override
  _BookAppointment createState() => _BookAppointment();
}
                        ...
                        if (snapshot.hasData) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                if(snapshot.data[index].booked == "false")
                                {
                                  return Container(
                                    decoration: BoxDecoration(
                                        color: Colors.white,
                                  ...
                                  return Text("Please wait till we add more slots");
                                }
